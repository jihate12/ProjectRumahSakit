...
<!-- 			<th>Nama </th> -->
		...
		<?php
			...
			while ($data = mysqli_fetch_array($res)){
				...
				echo "</td>";
				echo "<td>";
				echo "<a href='form_update_pasien.php?id=".$data['id_pasien']."'><button class='btn btn-primary'>ubah</button></a> &nbsp";
				echo "<button class='btn btn-danger' onclick='if(confirm(\"Yakin dihapus?\")) location.href=\"hapus_pasien.php?id=".$data['id_pasien']."\"'>Hapus</button>";
				echo "</td>";
				echo "</tr>";
			}
		?>
	...
	<br>
	<a href="form_tambah_pasien.php" class="btn btn-success" style="margin-left: 42%; margin-right: 0; margin-top: 1%; width: 150px;">tambah</a>
