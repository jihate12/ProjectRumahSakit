...
<html lang="en">
  ...
  <body>
    ...
    <!-- Login Bar-->
    <button type="submit" class="btn btn-primary form-group" name="login">Login</button>
   <button type="submit" class="btn btn-primary form-group" name="pegawai">pegawai</button>
    <?php
      session_start();
