  ...
  <body>
    ...
    <table class="table table-bordered table-borderless">
      <form method="post" action="tambah_pasien.php">
        <tr>
          <td>ID Pasien</td>
          <td><input type="text" name="id_pasien" class="form-control" placeholder="ID PASIEN" style=""></td>
        </tr>
        <tr>
          <td>Nama Pasien</td>
          <td><input type="text" name="nama_pasien" class="form-control" placeholder="NAMA PASIEN"></td>
        </tr>
        <tr>
          <td>alamat</td>
        ...
        <tr>
          ...
          <td><input type="text" name="no_tlp" class="form-control" placeholder="NO TELEPON"></td>
        </tr>
          <tr>
            <td>Jenis Pembayaran</td>
            <td>
              <div class="form-check form-check-inline">
                <input type="radio" name="jenis_pembayaran" class="form-check-input" value="Cash">
              ...
              <div class=" form-check form-check-inline">
            <input type="radio" name="jenis_pembayaran" class="form-check-input" value="Asuransi">
              <label class="form-check-label">
                  ASURANSI
              </label>
              </div>  
    ...
    <tr>
   <img src="pasien.png" height="200px" width="300px" style="margin-left: 1050px">
  </tr>
</html>